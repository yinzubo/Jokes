...
import com.bitech.joke.utils.slidr.model.*;
import com.bitech.joke.utils.slidr.widget.SliderPanel;
...
public class Slidr {
    ...
    /**
     * Attach a slideable mechanism to an activity that add s the slide to dismiss functionality
